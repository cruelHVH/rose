...
namespace ImGui
{
    ...
    // - DLL users: heaps and menu are not shared across DLL boundaries! You will need to call SetCurrentContext() + SetAllocatorFunctions()
...
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
    float       Fontmenucale;                    // Moved io.Fontmenucale to style.FontScaleMain in 1.92 (June 2025)
